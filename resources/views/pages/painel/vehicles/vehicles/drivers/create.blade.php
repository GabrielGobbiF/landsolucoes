                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" id="input--username" value="{{ $vehicle->username ?? old('username') }}" autocomplete="off">
                            </div>
                        </div>
