        ...
        <div class="card-body">
            <div class="filemgr-content-body ps ps--active-y arquivos">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                    <div>
                        <h4 class="mg-b-15 mg-lg-b-25">Todos as RDSE'S</h4>
                    </div>
                    <div class="tollbar btn-toolbar mb-2 mb-md-0 float-right">
                        <form id="" role="form" class="needs-validation" action="{{ route('rdse.files.index') }}"
                            method="GET">
                            <div class="form-inline">
                                <div class="input-group mb-3">
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-light">Buscar RDSE</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                ...
                <label class="d-block tx-medium tx-10 tx-uppercase tx-sans tx-spacing-1 tx-color-03 mg-b-15">Rdses</label>
                <div class="row">

                    @foreach ($rdses as $rdse)
                        <div class="col-3 mg-t-5">
                            <a href="{{ route('rdse.files.show', $rdse->id) }}" class="link-02">
                ...
                <div class="row d-flex justify-content-center mt-4">
                    <code> Para visualizar outras RDSE'S pesquise </code>
