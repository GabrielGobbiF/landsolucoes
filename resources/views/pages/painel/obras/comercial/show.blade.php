            ...
            @if ($financeiro)
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                    <ul class="nav nav-pills" id="v-tab" role="tablist">
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link active" data-tab="comercial" id="v-dados-tab" data-toggle="tab"
                                href="#v-dados" role="tab" aria-selected="true">
                                <span class="d-block d-sm-none"><i class="fas fa-home"></i></span>
                                <span class="d-none d-sm-block">Dados da Proposta</span>
                            </a>
                        </li>
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link" data-tab="comercial" id="v-financeiro-tab" data-toggle="tab"
                                href="#v-financeiro" role="tab" aria-selected="false">
                                <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                                <span class="d-none d-sm-block">Métodos de Pagamento</span>
                            </a>
                        </li>
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link" data-tab="comercial" id="v-iso-tab" data-toggle="tab" href="#v-iso"
                    ...
                    <h3 class="box-title float-right">
                        <a class="btn btn-outline-primary mt-1 mr-1" id="btn-listaCompra" data-toggle="collapse"
                            href="#lista_compra" aria-expanded="true" aria-controls="lista_compra">
                            Lista de Compra
                        </a>
                    </h3>
                </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="v-dados" role="tabpanel" aria-labelledby="v-dados">
                        <form role="form-update-comercial" class="needs-validation" novalidate id="form-driver"
                            autocomplete="off" action="{{ route('comercial.update', $comercial->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="concessionaria_id" class="form-control"
                                                        readonly disabled id="input--concessionaria_id"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="select--service"
                                                        class="@error('service_id') is-invalid-label @enderror">Tipo de
                                                        Obra/Serviço</label>

                                                    <input type="text" name="service_id" class="form-control" readonly
                                                        disabled id="input--service_id"
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <label for="select--client"
                                                        class="@error('client_id') is-invalid-label @enderror">Cliente</label>
                                                    <input type="text" name="client-id" class="form-control" readonly
                                                        disabled id="input--client-id"
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        class="form-control date @error('build_at') is-invalid @enderror"
                                                        name="build_at" id="input--build_at"
                                            ...
                                            <div class="col-md-12 d-none">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="viabilizacao[participantes]" id="input--participantes"
                    ...
                    <div class="tab-pane" id="v-financeiro" role="tabpanel" aria-labelledby="v-financeiro">
                        <form role="form-update-financeiro-comercial"
                            action="{{ route('comercial.update.financeiro', $comercial->id) }}" method="POST">
                            @csrf
                    ...
                    <div class="tab-pane" id="v-iso" role="tabpanel" aria-labelledby="v-iso">
                        <form id="form-update-comercial-viabilizacao" role="form" class="needs-validation" novalidate
                            id="form-driver" autocomplete="off" action="{{ route('comercial.update', $comercial->id) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="box box-default box-solid">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-checkbox mb-3">
                                                        <input type="checkbox" class="custom-control-input"
                                                            value="sim" name="viabilizacao[elaboracao]"
                                                            id="elaboracao"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-checkbox mb-3">
                                                        <input type="checkbox" class="custom-control-input"
                                                            value="sim" name="viabilizacao[qualidade]" id="qualidade"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-checkbox mb-3">
                                                        <input type="checkbox" class="custom-control-input"
                                                            value="sim" name="viabilizacao[ambiental]" id="ambiental"
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        name="viabilizacao[responsavel]" id="responsavel"
                                                ...
                                                @foreach (Config::get('constants.status_final_comercial') as $status)
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                            name="viabilizacao[viavel]" id="{{ $status['id'] }}"
                                                            value="{{ $status['id'] }}"
                                                        ...
                                                        <label class="form-check-label"
                                                            for="{{ $status['id'] }}">{{ $status['name'] }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="text" class="form-control" name="viabilizacao[observacoes]" id="observacoes">{{ isset($comercial) && isset($comercial->viabilizacao) ? $comercial->viabilizacao->observacoes : old('viabilizacao.observacoes') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
