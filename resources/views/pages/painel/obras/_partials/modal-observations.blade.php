    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input id="modal-obraId" type="hidden" class="">
...
@section('modal-scripts')
    ...
    @once
        ...
        <script>
            ...
            function openObservationModal(obraId, row) {
                ...
                axios.get(`${base_url}/api/v1/obras/${obraId}`)
                    .then(function(response) {
                        console.log(response)
                        $("#modal-row_value").val(response.data.data.observations)
                        $("#modal-row").val(row)
                        $("#modal-obraId").val(obraId)
                        init();
                    })
            }
            ...
            function saveContent(content) {
                ...
                var span = '';
                let obraId = $("#modal-obraId").val();

                // Enviar o conteúdo via Axios para o backend
                axios.put(`${base_url}/api/v1/obras/${obraId}`, {
                        collumn: url,
                        value: content,
                    })
                    .then(function(response) {})
