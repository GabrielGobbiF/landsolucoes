    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="input--name"
                    value="{{ $employee->name ?? old('name') }}" autocomplete="off" required>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" name="rg" class="form-control rg @error('rg') is-invalid @enderror" id="input--rg"
                    value="{{ $employee->rg ?? old('rg') }}" autocomplete="off" required>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" name="ctps" class="form-control @error('ctps') is-invalid @enderror" id="input--ctps" required
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <select name="estado_civil" id="input--estado_civil" required
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" name="date_contract"
                    class="form-control date @error('date_contract') is-invalid @enderror" id="input--date_contract" required
