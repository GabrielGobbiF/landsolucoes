...
$countNotifications = $notifications ? $notifications->count() : '';
@endphp
<div class="dropdown d-inline-block">
    <button type="button" class="btn header-item noti-icon waves-effect" id="page-header-notifications-dropdown"
        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <i class="fas fa-bell"></i>
        <span class="{{ $countNotifications > 0 ? 'noti-dot' : '' }}"></span>
    </button>
    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
        ...
        <div class="p-3">
            <div class="row">
                ...
                <div class="col">
                    <a href="{{ route('notifications.read.all') }}" class="float-right">{{ $countNotifications != 0 ? 'Marcar todas como lida' : '' }}</a>
                </div>
            </div>
        </div>
        ...
        <div class="p-2 border-top">
            <a class="btn btn-sm btn-link font-size-14 btn-block text-center" href="{{ route('notification') }}">
                <i class="fas fa-check"></i> Ver todas
            </a>
        </div>
    </div>
</div>
@section('scripts')
    <script>
        $(document).ready(function() {
            $('.notification-item-header').on('click', function() {
