...
@section('title', 'Produto - ' . ucfirst($produto->nome))
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-md-12">
                    ...
                    <button type="button" class="btn btn-outline-danger js-btn-delete float-left" data-text="Excluir Produto" data-href="{{ route('produtos.destroy', $produto->id) }}"><i class="fas fa-trash"></i></button>
                </div>
            </div>
        </div>
    </form>
