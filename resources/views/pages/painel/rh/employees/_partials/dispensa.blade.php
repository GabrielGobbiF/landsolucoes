<table class="table">
    <tbody>
        @foreach ($documentos['documentos_dispensa'] as $documento)
            <tr data-id="{{ $documento->id }}" data-name="{{ $documento->name }}" data-type="dispensa">
                    ...
                    <div class="form-group">
                        <div class="radio">
                            ...
                            @if ($documento->status != '1')
                                <label>
                                    <input type="radio" data-collumn="status" class="status"
                                        name="status_{{ $documento->id }}" id="option_nao_{{ $documento->id }}"
