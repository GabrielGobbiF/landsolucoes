                                                        ...
                                                        @foreach ($unreadNotifications as $unreadNotification)
                                                            <tr>
                                                                <th class="text-reset notification-item-noti pd-10-f">
                                                                    <a href="{{ route('notifications.show', $unreadNotification->id) }}" class="">
                                                                        <div class="media">
                                                ...
                                                <table class="table table-centered ">
                                                    <tbody>
                                                        @foreach ($readNotifications as $readNotification)
                                                            <tr>
                                                                <th class="text-reset notification-item-noti pd-10-f">
                                                                    <a href="{{ route('notifications.show', $readNotification->id) }}" class="">
                                                                        <div class="media">
                                                                            <div class="avatar-xs mr-3">
                                                                                <span class="avatar-title bg-primary rounded-circle font-size-16">
                                                ...
                                                <table class="table table-centered ">
                                                    <tbody>
                                                        @foreach ($archiveds as $archivedNotification)
                                                            <tr>
                                                                <th class="text-reset notification-item-noti pd-10-f">
                                                                    <a href="{{ route('notifications.show', $archivedNotification->id) }}" class="">
                                                                        <div class="media">
                                                                            <div class="avatar-xs mr-3">
                                                                                <span class="avatar-title bg-primary rounded-circle font-size-16">
                                                ...
                                                <table class="table table-centered ">
                                                    <tbody>
                                                        @foreach ($trasheds as $trashedNotification)
                                                            <tr>
                                                                <th class="text-reset notification-item-noti pd-10-f">
                                                                    <a href="{{ route('notifications.show', $trashedNotification->id) }}" class="">
